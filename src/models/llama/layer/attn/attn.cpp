...
void LlamaAttention::forward(LlamaContext &ctx) {
    ...
    layers::utils::linear_proj(ws.q, qkv_in, qkv_scale, w.q_w, w8 ? w8->q_scale : nullptr, nullptr);
    layers::utils::linear_proj(ws.k, qkv_in, qkv_scale, w.k_w, w8 ? w8->k_scale : nullptr, nullptr);
    layers::utils::linear_proj(ws.v, qkv_in, qkv_scale, w.v_w, w8 ? w8->v_scale : nullptr, nullptr);
