                    ...
                    const size_t &nkvh)
{
    ...
    case LLAISYS_DTYPE_F32:
        flash_decoding_v2_dispatch<float>(attn_val, attn_acc, attn_sum, attn_max, q, k_cache, v_cache,
            block_ids, cut_idx, tot_len, token_num, batch_size, max_block_num, tot_block_num,
            scale, nh, dv, d, nkvh, 0, 0);   // 0,0 → 自动选参
        break;
    case LLAISYS_DTYPE_F16:
        flash_decoding_v2_dispatch<llaisys::fp16_t>(attn_val, attn_acc, attn_sum, attn_max, q, k_cache, v_cache,
            block_ids, cut_idx, tot_len, token_num, batch_size, max_block_num, tot_block_num,
            scale, nh, dv, d, nkvh, 0, 0);
        break;
    case LLAISYS_DTYPE_BF16:
        flash_decoding_v2_dispatch<llaisys::bf16_t>(attn_val, attn_acc, attn_sum, attn_max, q, k_cache, v_cache,
            block_ids, cut_idx, tot_len, token_num, batch_size, max_block_num, tot_block_num,
            scale, nh, dv, d, nkvh, 0, 0);
        break;
    default:
