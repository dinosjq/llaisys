...
__C {
    ...
    __export void llaisysPagedAttention(llaisysTensor_t attn_val, llaisysTensor_t q, llaisysTensor_t k_cache, llaisysTensor_t v_cache, llaisysTensor_t block_ids_tensor, llaisysTensor_t cut_idx_tensor, llaisysTensor_t tot_len_tensor, size_t max_seq_len, float scale, bool is_prefill, llaisysTensor_t attn_acc, llaisysTensor_t attn_sum, llaisysTensor_t attn_max);
