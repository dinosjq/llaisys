#!/usr/bin/env python3
"""ncu profiling targets for v4 and v5 parallel kernels."""
...
tests = [
    ("V4_H6T8C1","llaisysFlashDecodingV4",6,8,1),
    ("V4_H6T8C4","llaisysFlashDecodingV4",6,8,4),
    ("V5_H6T8C1","llaisysFlashDecodingV5",6,8,1),
    ("V5_H3T16C4","llaisysFlashDecodingV5",3,16,4),
]
