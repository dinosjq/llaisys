...
# One combo at a time: v3 H6T8, v3 H2T16, v5 H6T8 C1, v5 H6T8 C4, v5 H2T16 C1, v5 H3T16 C8
tests = [
    ("V3","llaisysFlashDecodingV3",6,8,0),
    ("V3","llaisysFlashDecodingV3",2,16,0),
    ("V5","llaisysFlashDecodingV5",6,8,1),
    ("V5","llaisysFlashDecodingV5",6,8,4),
    ("V5","llaisysFlashDecodingV5",2,16,1),
    ("V5","llaisysFlashDecodingV5",3,16,8),
]
...
for batch, totlen in [(1,256),(1,2048),(4,2048),(16,512)]:
    ...
    for tag,fn,h,tk,co in tests:
        ...
        label=f"{tag}_B{batch}T{totlen}_H{h}K{tk}C{co}"
