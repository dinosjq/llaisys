...
for batch, totlen in [(1,256),(1,1024),(1,2048)]:
    ...
    for h,tk,co,ns,ur in [(6,8,1,2,0),(6,8,1,2,1),(2,16,1,2,0),(6,16,1,2,1)]:
        ...
        torch.cuda.nvtx.range_push(f"B{batch}T{totlen}_H{h}K{tk}C{co}S{ns}U{ur}")
