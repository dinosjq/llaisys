...
def main():
    ...
    if args.ncu_child:
        buf = setup_kv_cache_move(
            QWEN2_SHAPES[0]["batch"], QWEN2_SHAPES[0]["max_seq_len"],
            QWEN2_SHAPES[0]["nkvh"], QWEN2_SHAPES[0]["dh"], dtype_name)
        llaisys_kv_cache_move(buf); torch.cuda.synchronize(); return
