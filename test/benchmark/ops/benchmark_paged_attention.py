...
def main():
    ...
    if args.ncu_child:
        buf = setup_paged_attention(
            QWEN2_SHAPES[0]["seqlen"], QWEN2_SHAPES[0]["token_num"],
            QWEN2_SHAPES[0]["block_num"], QWEN2_SHAPES[0]["block_ids"],
            QWEN2_SHAPES[0]["nh"], QWEN2_SHAPES[0]["nkvh"],
            QWEN2_SHAPES[0]["hd"], dtype_name)
        llaisys_paged_attention(buf); torch.cuda.synchronize(); return
